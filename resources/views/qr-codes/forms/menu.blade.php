        ...
        <div id="menu-design-section-content">
            ...
            <div class="mb-6">
                <div class="grid grid-cols-2 md:flex gap-3 mb-4">
                    ...
                    <button type="button" class="menu-color-preset border-2 border-dark-200 rounded-lg p-2 hover:border-primary-400 transition-colors" data-primary="#E5E7EB" data-secondary="#FFDAD8">
                        <div class="flex gap-1">
