    ...
    block.innerHTML = `
        ...
        <div class="space-y-3">
            <div>
                ...
                <div class="menu-product-image-upload-area border-2 border-dashed border-dark-200 rounded-lg p-4 text-center cursor-pointer hover:border-primary-400 transition-colors">
                    ...
                    <label for="${productId}-image" class="cursor-pointer flex flex-col items-center gap-1">
                        ...
                        <span class="text-xs text-dark-200">Maximum size: 5MB</span>
                    </label>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div>
                    <label class="label text-sm">Name translation</label>
                    <input type="text" name="menu_sections[${sectionIndex}][products][${productIndex}][name_translation]" class="input w-full" placeholder="e.g. Enter item name translation">
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                ...
                <div>
                    <label class="label text-sm">Description translation</label>
                    <input type="text" name="menu_sections[${sectionIndex}][products][${productIndex}][description_translation]" class="input w-full" placeholder="e.g. Translation if needed">
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
