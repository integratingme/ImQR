...
<div class="space-y-6">
    <div>
        ...
        <div id="coupon-upload-area" class="border-2 border-dashed border-dark-200 rounded-lg p-8 text-center hover:border-primary-400 transition-colors">
            <input type="file" id="coupon_image" name="coupon_image" accept="image/jpeg,image/png,image/jpg,image/gif,image/webp,image/svg+xml" class="hidden" required onchange="handleImagePreview(this, 'coupon-img-preview', 'coupon-upload-area')">
    ...
    <div>
        ...
        <div id="logo-upload-area" class="border-2 border-dashed border-dark-200 rounded-lg p-6 text-center hover:border-primary-400 transition-colors">
            <input type="file" id="logo" name="logo" accept="image/jpeg,image/png,image/jpg,image/gif,image/webp,image/svg+xml" class="hidden" onchange="handleImagePreview(this, 'logo-img-preview', 'logo-upload-area')">
