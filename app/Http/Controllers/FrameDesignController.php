...
class FrameDesignController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $frames = FrameDesign::query()
            ...
            ->get(['id', 'name', 'thumbnail_url', 'is_template', 'design_json', 'svg_content']);
    ...
    public function update(Request $request, FrameDesign $frame): JsonResponse
    {
        ...
        $frame->update([
            'name' => $validated['name'],
            'design_json' => $validated['design_json'],
            'svg_content' => $validated['svg_content'] ?? $frame->svg_content,
            'thumbnail_url' => $thumbnailUrl,
        ]);
    ...
    private function validationRules(): array
    {
        return [
            ...
            'design_json.layers.*.type' => 'required_with:design_json.layers|string|in:rect,circle,text,image',
